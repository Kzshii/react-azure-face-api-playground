# Azure Face API Playground

This is a simple project used to test the Face API offered by Microsoft Azure.

![Project Homepage](.github/homescreen.png)

It has a simple implementation showing and demonstrating how to use React and ES6
to consume the Face API Service, as well as a simple interface to interact
with the service.

Actually it has these functionalities implemented:
...
```sh
# export azure face api as environment variable
...
## About this project's boilerplate
